...
//        }
        if (!isset($this->buttons['update'])) {
            $this->buttons['update'] = function ($url, $model, $key) {
                ...
                return Html::a('<span class="glyphicon glyphicon-pencil"></span>', '/goods/edit?id='.$model->id, $options);
            };
        }
        if (!isset($this->buttons['delete'])) {
            $this->buttons['delete'] = function ($url, $model, $key) {
                ...
                return Html::a('<span class="glyphicon glyphicon-trash"></span>', '/goods/del?id='.$model->id, $options);
            };
        }
    }
}
